...
The package to control the potentiostats is the subfolder [thales_remote](thales_remote). The package [zahner_analysis](https://github.com/Zahner-elektrik/Zahner-Analysis-Python) contains the library for importing Thales file formats (This package was formerly a part of this repository). The class [BCMuxInterface](https://doc.zahner.de/thales_remote/bc_mux_interface.html) to control the [BC-MUX](https://zahner.de/products-details/multiplexer/bc-mux) is located in the Python file [BCMuxInterface.py](Examples/BCMuxInterface/BCMuxInterface.py), from this file the class can be imported.
...
Download the subdirectory [thales_remote](thales_remote) and put this directory into your source directory where your Python script is located.  
Or add the path of the directory [thales_remote](thales_remote) on your computer to the [PYTHONPATH](https://docs.python.org/3/using/cmdline.html#envvar-PYTHONPATH).
